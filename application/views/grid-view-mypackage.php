<section class="grid__view mt-4">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <p style="float:right;">
                    <a href="<?php echo base_url('mypackagestable');?>" class="btn btn-success">Table View</a>
                </p>
        ...
        <div class="row  mt-md-3">
            ...
            <div class="col-md-8">
                <div class="row ">
                    ...
                    <?php if($Packages){ $cnt=0;
                        foreach ($Packages as $key => $packagepack) {
                            $cnt++;
                            ...
                            if($days>=0)
                            {
                                ...
                                <div class="col-md-6 text-center">
                                    <div class="panel panel-success panel-pricing">
                                        ...
                                        <li class="list-group-item">Package Type:<?php echo $packagepack->package_type;?></li>

                                        <li class="list-group-item">Package Price:<?php if($packagepack->package_type=='Free'){ echo '<i class="fa fa-inr" aria-hidden="true"></i>'.'00.00';} else{ echo '<i class="fa fa-inr" aria-hidden="true"></i>'.$packagepack->package_price;}?></li>
                                        <!--   <li class="list-group-item"><?php echo $packagepack->package_duration.'days';?></li> -->
                                        <div class="panel-body text-center">
                                            <p><strong> <i class="fa fa-clock-o"></i> Duration :<?php echo $packagepack->package_duration.'days';?></strong></p>
                                        </div>
                                        <ul class="list-group text-center">

                                            <li class="list-group-item">Package Started:<?php echo $packagepack->package_start;?></li>
                                            <li class="list-group-item">Package will end at:<?php echo $packagepack->end_enddate;?></li>
                                            <li class="list-group-item">Days left to expire this package:<?php echo $days;?></li>
                                            <li class="list-group-item">Total PCBT Test: <?php echo $packagepack->tot_cbt_test;?></li>
                                            <li class="list-group-item">Number of MCQS: <?php echo $packagepack->mcq_in_cbt;?></li>
                                            <li class="list-group-item">Frequency(Per Test in Days): <?php echo $packagepack->frequency_oc_cbt;?></li>
