        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box dashbaord">
                    <h3 class="text-left"><i class="fa fa-link" aria-hidden="true"></i> Edit Appreciation 
                    </h3>
                                 ...
                                 <tr>
                                    ...
                                    <td id="dis_phone">
                                        <input type="file" class="form-control" 
                                               name="profile_pic" />
        <?php if($f->image){?><img src="<?=base_url();?>uploads/<?=$f->image;?>" width='100' height='100'/> 
        <?php }?>    
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td id="dis_fname">
<textarea type="text" class="form-control" name="feedback"><?=$f->feedback;?></textarea></td>
                                </tr>
                                   <tr>
                                 ...
                                 <input type="hidden" name='id' value="<?=$f->id;?>">
                                        <input class="rating" name='rating' value="<?=$f->rating;?>">
                           <input  type="hidden" name='id' value="<?=$f->id;?>">
                                    </td>
                                </tr>
