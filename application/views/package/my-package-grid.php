                        ...
                        if ($packages) {
                            ...
                            foreach ($packages as $key => $package) {
                                ...
                                if ($days >= 0) {
                                    ...
                                    $remaining=($datetime2 - $datetime1)/86400;
                    ?>

                                <div class="col-md-4 text-center">
                                    <div class="card panel-pricing mt-3">
                                        <!--<div class="card-header">-->
<div class="grid_logo p-3 alert-warning" style="background:#adf1ad"><img
                                                        src="<?php echo base_url() . 'assets/images/packages/' . $package->image; ?>"
                                                        alt="" style="height:200px; width:400px;"></div>
            <h4 style="background:#adf1ad;
    padding: 6px;color: #996609;margin:0"><?php echo $package->package_name; ?></h4>
                                            <ul class="list-group text-center list-group-flush">
                                                ...
                                                <li class="list-group-item"><b>Days left to expire this package : <?php echo $remaining; ?></b></li>
