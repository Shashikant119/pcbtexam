...
<section class="grid__view mt-4">
    <div class="container">
        ...
        <div class="row mb-3 ">
            ...
            <div class="col-6">
                <p style="float:right;">
                    <a href="<?php echo base_url('packagespricinggrid');?>" class="btn btn-success">Grid View</a>
                </p>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if($package){ $cnt=0;foreach ($package as $key => $packagepack) { $cnt++;
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <a href="<?php echo base_url('subscribenowmypackage/'.$packagepack->package_id);?>" class="btn btn-success">SUBSCRIBE NOW</a>
                                </td>
                            </tr>
